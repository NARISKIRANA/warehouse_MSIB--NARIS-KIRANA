...
class Warehouse {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . " SET name=:name, location=:location, capacity=:capacity, opening_hour=:opening_hour, closing_hour=:closing_hour, status='aktif'";
    ...
    // RESTORE (Set status to 'aktif')
    public function restore() {
        $query = "UPDATE " . $this->table_name . " SET status='aktif' WHERE id=:id";
        $stmt = $this->conn->prepare($query);
        $stmt->bindParam(':id', $this->id);
